...
package modelengine.fel.pipeline.huggingface.service;

import com.fasterxml.jackson.databind.ObjectMapper;

import modelengine.fel.pipeline.huggingface.api.HuggingFacePipelineApi;
...
public class HuggingFacePipelineServiceImpl implements HuggingFacePipelineService {
    ...
    private void handleError(Response<Object> response, String errorMessage) {
    ...
    public Object call(String task, String model, Map<String, Object> args) {
        try {
            ...
            if (response.code() != HTTP_NOT_FOUND) {
                this.handleError(response, "Failed to call Hugging Face pipeline");
