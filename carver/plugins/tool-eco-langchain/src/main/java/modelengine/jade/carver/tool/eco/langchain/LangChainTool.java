...
import modelengine.jade.carver.tool.eco.AbstractKvTool;

/**
 * 表示 {@link modelengine.jade.carver.tool.Tool} 的
...
public class LangChainTool extends AbstractKvTool {
     ...
     */
    public LangChainTool(BrokerClient brokerClient, ObjectSerializer serializer, ToolInfo itemInfo, Metadata metadata) {
