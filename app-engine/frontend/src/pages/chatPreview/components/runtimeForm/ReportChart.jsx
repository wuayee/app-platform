...
import ChartItem from '../chart-message/chart-item';
import {Input} from "antd";
const {TextArea} = Input;
const ReportChart = (props) => {
    const { answer, chartAnswer, chartData, chartTitle, chartType, chartSummary } = props.chartConfig;
        ...
        if (chartData) {
            if (Array.isArray(chartData)) {
                chartData.forEach((item, index) => {
                    ...
                    const chartSummaryItem = chartSummary[index];
                    const chartItem = initChartData(item, chartTypeItem, chartTitleItem, chartSummaryItem);
                    setChartList(() => {
                ...
                const chartItem = initChartData( chartData, chartType, chartSummary);
                setChartList(() => {
                    let current = listRef.current || [];
    ...
    // 组装数据
    function initChartData(chartData, chartType, chartTitle, chartSummary) {
        const chartItem = {
            chartData,
            chartType,
            chartAnswer,
