...
import static com.huawei.fit.ohscript.util.Constants.SYSTEM_EXTENSION;
import static com.huawei.fit.ohscript.util.Constants.SYSTEM_UTIL;

import com.huawei.fit.ohscript.script.lexer.Lexer;
import com.huawei.fit.ohscript.script.parser.codereader.CodeReader;
import com.huawei.fit.ohscript.script.parser.codereader.OhFileReader;
import com.huawei.fit.ohscript.script.parser.codereader.StringCodeReader;
...
public class ParserBuilder {
    ...
    private void loadSystemCode() {
        ...
        this.parseString(SYSTEM_UTIL, utilCode);
        String imports = "import log, warning, error, panic, sleep from " + SYSTEM_UTIL + ";";
        ...
        this.parseString(SYSTEM_EXTENSION, extCode);
    }
