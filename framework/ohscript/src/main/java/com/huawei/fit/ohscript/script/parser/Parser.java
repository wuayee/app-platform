...
import static com.huawei.fit.ohscript.script.parser.NonTerminal.SCRIPT;
...
import com.huawei.fit.ohscript.script.parser.nodes.EndNode;
...
public class Parser {
    ...
    static {
        imports.add("import log, warning, error, panic, sleep from " + SYSTEM_UTIL + ";");
        imports.add("import * from " + SYSTEM_EXTENSION + ";");
    }
