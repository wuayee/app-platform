...
import com.huawei.fit.ohscript.script.semanticanalyzer.SemanticAnalyzer;
import com.huawei.fit.ohscript.script.semanticanalyzer.SymbolTable;
...
public class AST implements Serializable {
    ...
    private Object matchEntityFieldValue(Class<?> fieldType, Map<String, ReturnValue> value) throws Exception {
        Object obj = createInstance(fieldType);
    ...
    private Object matchItem(Class<?> itemType, Object value) throws Exception {
        ...
        Object item = createInstance(itemType);
    ...
    public Object mockReturnValue(ASTEnv env, Object value, ActivationContext current) {
        ...
        object.put(EXTERNAL_VALUE, new ReturnValue(current, TypeExprFactory.createIgnore(), newValue));
        return object;
    }

    private Object matchArg(Object argValue, ASTEnv env) {
        Object arg = argValue;
        if (argValue instanceof Map && ((Map<String, ReturnValue>) argValue).containsKey(EXTERNAL_VALUE)) {
            arg = ((Map<String, ReturnValue>) argValue).get(EXTERNAL_VALUE).value();
        }
    ...
    private void handleArg(Parameter[] parameters, Object[] argValues, ASTEnv env, int i, Object[] args) {
        ...
        if (argValue instanceof Map) {
            ...
            if (map.containsKey(EXTERNAL_VALUE)) {
                args[i] = map.get(EXTERNAL_VALUE).value();
            } else {
    ...
    public Pair<EntityDeclareNode, ExternalWrapper> mockExternalOh(String key, Object externalOh) {
        ...
        this.mockEntityField(entity, EXTERNAL_VALUE.substring(1), new ExternalDataNode(wrapper));
