...
import com.huawei.fit.waterflow.domain.parsers.nodes.filters.BatchSizeFilterParser;
import com.huawei.fit.waterflow.domain.parsers.nodes.filters.FilterParser;
import com.huawei.fit.waterflow.domain.parsers.nodes.filters.TransBatchSizeFilterParser;
import com.huawei.fit.waterflow.domain.validators.rules.filters.BatchSizeFilterRule;
import com.huawei.fit.waterflow.domain.validators.rules.filters.FilterRule;
import com.huawei.fit.waterflow.domain.validators.rules.filters.TransBatchSizeFilterRule;
