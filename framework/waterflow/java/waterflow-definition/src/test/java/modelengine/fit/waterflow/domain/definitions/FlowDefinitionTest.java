...
package modelengine.fit.waterflow.domain.definitions;
...
import modelengine.fit.waterflow.domain.parsers.FlowParser;
import modelengine.fit.waterflow.domain.parsers.Parser;
...
class FlowDefinitionTest {
    ...
    class FlowManualExecutorInMemoryTest extends FlowsDataBaseTest {
        ...
        void testFlowsManualExecutorWithConditionNodeFirstBranchTrue() {
            ...
            From<FlowData> resumeFrom = ObjectUtils.cast(WaterFlows.getPublisher(resumeContext.getStreamId()));
        ...
        void testFlowsManualExecutorWithConditionNodeCircle() {
            ...
            resumeFrom = ObjectUtils.cast(WaterFlows.getPublisher(resumeContext.getStreamId()));
    ...
    class FlowAutoExecutorInMemoryMtoNtest extends FlowsDataBaseTest {
        ...
        private String runFlow3(From<FlowData> from, String streamId, String eventMetaId) {
            ...
            From<FlowData> resumeFrom3 = ObjectUtils.cast(WaterFlows.getPublisher(resumeContext3.getStreamId()));
        ...
        private String runFlow1(FlowData flowData1, From<FlowData> from, String streamId, String eventMetaId) {
            ...
            From<FlowData> resumeFrom1 = ObjectUtils.cast(WaterFlows.getPublisher(resumeContext1.getStreamId()));
