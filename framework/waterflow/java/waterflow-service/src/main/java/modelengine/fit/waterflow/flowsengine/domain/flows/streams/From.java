...
public class From<I> extends IdGenerator implements FitStream.Publisher<I> {
     ...
     */
    @Override
    public <O> FitStream.Processor<O, O> conditions(Just<FlowContext<O>> processor, Map<I, O> convert, Whether<I> whether) {
     ...
     */
    @Override
    public <M, O> FitStream.Processor<M, O> join(Reduce<FlowContext<M>, O> processor, Map<I, M> convert, Whether<I> whether) {
     ...
     */
    @Override
    public <M, O> FitStream.Processor<M, O> map(Map<FlowContext<M>, O> processor, Map<I, M> convert, Whether<I> whether) {
    ...
    @Override
    public <M, O> FitStream.Processor<M, O> flatMap(FlatMap<FlowContext<M>, O> processor, Map<I, M> convert, Whether<I> whether) {
        Node<M, O> node = new Node<>(this.getStreamId(), processor, repo, messenger, locks);
        this.subscribe(node, convert, whether);
        return node;
    }
     ...
     */
    @Override
    public <M, O> FitStream.Processor<M, O> reduce(Reduce<FlowContext<M>, O> processor, Map<I, M> convert, Whether<I> whether) {
        Node<M, O> node = new Node<>(this.getStreamId(), processor, repo, messenger, locks);
        this.subscribe(node, convert, i -> true);
        return node;
    }
     ...
     */
    @Override
    public <M, O> FitStream.Processor<M, O> produce(Produce<FlowContext<M>, O> processor, Map<I, M> convert, Whether<I> whether) {
        Node<M, O> node = new Node<>(this.getStreamId(), processor, repo, messenger, locks);
        this.subscribe(node, convert, i -> true);
        return node;
    }
     ...
     */
    @Override
    public <M, O> void subscribe(String eventId, FitStream.Subscriber<M, O> subscriber, Map<I, M> convert, Whether<I> whether) {
