...
public class ConditionsNode<I> extends Node<I, I> {
     ...
     * @param locks 流程锁
     */
    public ConditionsNode(String streamId, Just<FlowContext<I>> processor, FlowContextRepo repo,
     ...
     * @param nodeType 节点类型
     */
    public ConditionsNode(String streamId, String nodeId, Just<FlowContext<I>> processor, FlowContextRepo repo,
