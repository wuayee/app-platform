...
import com.huawei.fit.waterflow.flowsengine.domain.flows.streams.FitStream.Callback;
...
import com.huawei.fit.waterflow.flowsengine.domain.flows.streams.Processors.Error;
...
import com.huawei.fit.waterflow.flowsengine.domain.flows.streams.callbacks.ToCallback;
    ...
    public enum ProcessMode {
        ...
        private <T1, R1> void handleProcessConcurrentConflict(To<T1, R1> to) {
            ...
            LOG.info("[{}] process thread conflict happens for stream-id: {}, node-id: {}",
                    to.getThreadName(To.PROCESS_T_NAME_PREFIX), to.streamId, to.id);
            to.accept(ProcessType.PROCESS, ready);
        }
    }
}
