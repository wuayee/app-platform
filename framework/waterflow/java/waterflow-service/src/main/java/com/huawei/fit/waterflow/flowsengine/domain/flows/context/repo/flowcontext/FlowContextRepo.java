...
import com.huawei.fit.waterflow.flowsengine.domain.flows.streams.Processors.Filter;
import com.huawei.fit.waterflow.flowsengine.domain.flows.streams.Processors.Validator;
...
public interface FlowContextRepo<T> {
    ...
    default List<FlowContext<T>> findByStreamId(String metaId, String version) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findByStreamId");
    }
    ...
    default Integer findRunningContextCountByMetaId(String metaId, String version) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findRunningContextByMetaId");
    }
    ...
    default void delete(String metaId, String version) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "delete");
    }
    ...
    default List<FlowContext<T>> findByTraceId(String traceId) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findByTraceId");
    }
    ...
    default List<String> getRunningContextsIdByTransaction(String flowTransId) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "getRunningContextsIdByTransaction");
    }
    ...
    default List<String> getRunningContextsIdByTraceId(String traceId) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "getRunningContextsIdByTraceId");
    }
    ...
    default List<FlowContext<FlowData>> findFinishedContextsPagedByTransId(String flowTransId, String endNode,
        ...
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findPageByStatusAndTransId");
    }
    ...
    default int findFinishedPageNumByTransId(String flowTransId, String endNode) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findFinishedPageNumByTransId");
    }
    ...
    default List<FlowContext<FlowData>> getEndContextsPagedByTransId(String flowTransId, String endNode,
            Integer pageNum, Integer limit) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "getEndContextsPagedByTransId");
    }
    ...
    default int findEndContextsPageNumByTransId(String flowTransId, String endNode) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findEndContextsPageNumByTransId");
    }
    ...
    default List<FlowContext<FlowData>> getErrorContextsPagedByTransId(String flowTransId, Integer pageNum,
            Integer limit) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "getErrorContextsPagedByTransId");
    }
    ...
    default int findErrorContextsPageNumByTransId(String flowTransId) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findErrorContextsPageNumByTransId");
    }
    ...
    default List<String> getTraceByTransId(String transId) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "getTraceByTransId");
    }
    ...
    default void deleteByTransId(String transId) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "deleteByTransId");
    }
    ...
    default List<FlowContext<FlowData>> findFinishedContextsPagedByTraceId(String traceId, String endNode,
            Integer pageNum, Integer limit) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findFinishedContextsPagedByTraceId");
    }
    ...
    default int findFinishedPageNumByTraceId(String traceId, String endNode) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findFinishedPageNumByTraceId");
    }
    ...
    default List<FlowContext<FlowData>> getEndContextsPagedByTraceId(String traceId, String endNode, Integer pageNum,
            Integer limit) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "getEndContextsPagedByTraceId");
    }
    ...
    default int findEndContextsPageNumByTraceId(String traceId, String endNode) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findEndContextsPageNumByTraceId");
    }
    ...
    default List<FlowContext<FlowData>> getErrorContextsPagedByTraceId(String traceId, Integer pageNum, Integer limit) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "getErrorContextsPagedByTraceId");
    }
    ...
    default List<FlowContext<T>> getRunningContextsByTraceId(String traceId) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "getRunningContextsByTraceId");
    }
    ...
    default TraceOwnerService getTraceOwnerService() {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "getTraceOwnerService");
    }
    ...
    default void deleteByContextIds(List<String> contextIds) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "deleteByContextIds");
    }
    ...
    default List<String> findTraceIdsByContextIds(List<String> contextIds) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findTraceIdsByContextIds");
    }
    ...
    default List<FlowContext<FlowData>> findFinishedContextsByTransId(String flowTransId, String endNode) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findFinishedContextsByTransId");
    }
    ...
    default List<FlowContext<FlowData>> findFinishedContextsByTraceId(String flowTraceId, String endNode) {
        throw new JobberException(ErrorCodes.FLOW_ENGINE_DATABASE_NOT_SUPPORT, "findFinishedContextsByTraceId");
    }
