...
public class JoinNode<I, O> extends Node<I, O> {
     ...
     * @param locks 流程锁
     */
    public JoinNode(String streamId, Reduce<FlowContext<I>, O> processor, FlowContextRepo repo,
     ...
     * @param nodeType 节点类型
     */
    public JoinNode(String streamId, String nodeId, Reduce<FlowContext<I>, O> processor, FlowContextRepo repo,
