...
class ConvertConditionToRuleUtilsTest {
    ...
    public void testNotEqualConditionFromReference() {
        ...
        String expectedOutput = "(businessData._internal.outputScope.node1.value1 != businessData._internal.outputScope.node2.value2)";
        assertEquals(expectedOutput, ConvertConditionToRuleUtils.convert(jsonInput));
    }
    ...
    public void testIsTrueCondition() {
        ...
        String expectedOutput = "(businessData._internal.outputScope.node1.isActive)";
        assertEquals(expectedOutput, ConvertConditionToRuleUtils.convert(jsonInput));
    }
    ...
    public void testIsEmptyConditionFromReference() {
        ...
        String expectedOutput = "(businessData._internal.outputScope.node1.list.isEmpty())";
        assertEquals(expectedOutput, ConvertConditionToRuleUtils.convert(jsonInput));
    }
    ...
    public void testMixedConditionsOr() {
        ...
        String expectedOutput = "(businessData._internal.outputScope.node1.flag) || (businessData._internal.outputScope.node2.array.isEmpty())";
        assertEquals(expectedOutput, ConvertConditionToRuleUtils.convert(jsonInput));
    }
    ...
    public void testBooleanInput() {
        ...
        String expectedOutput = "(businessData._internal.outputScope.6qm5eg.222 == false)";
        assertEquals(expectedOutput, ConvertConditionToRuleUtils.convert(jsonInput));
    }
}