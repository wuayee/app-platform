...
import static com.huawei.fit.waterflow.flowsengine.domain.flows.enums.FlowJoberType.GENERAL_JOBER;
import static com.huawei.fit.waterflow.flowsengine.domain.flows.enums.FlowJoberType.GENERICABLE_JOBER;
import static com.huawei.fit.waterflow.flowsengine.domain.flows.enums.FlowJoberType.HTTP_JOBER;
import static com.huawei.fit.waterflow.flowsengine.domain.flows.enums.FlowJoberType.OHSCRIPT_JOBER;
import static com.huawei.fit.waterflow.flowsengine.domain.flows.enums.FlowJoberType.STORE_JOBER;
...
import static com.huawei.fit.waterflow.flowsengine.domain.flows.enums.FlowNodeType.CONDITION;
import static com.huawei.fit.waterflow.flowsengine.domain.flows.enums.FlowNodeType.END;
import static com.huawei.fit.waterflow.flowsengine.domain.flows.enums.FlowNodeType.EVENT;
...
import static com.huawei.fit.waterflow.flowsengine.domain.flows.enums.FlowTaskType.APPROVING_TASK;
...
public class FlowParserTest extends FlowsDataBaseTest {
    ...
    public void testGenericableJoberParserSuccess() {
        ...
        Assertions.assertEquals(GENERICABLE_JOBER, flowJober.getType());
