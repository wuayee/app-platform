...
public class FlowContextPersistTest extends DatabaseBaseTest {
    ...
    class FlowAutoExecutorInPersistTest extends FlowsDataBaseTest {
        ...
        void testFlowsExecutorWithOnlyStateNode1To1() {
            ...
            assertSingleInstance(WaterFlows.getPublisher(streamId), from);
        ...
        void testFlowsExecutorStateNodeWithErrorForFirstNode1To1() {
            ...
            List<FlowContext<FlowData>> contexts = FlowsTestUtil.waitSingle(
                    contextSupplier(REPO, streamId, traceId, flowNode.getMetaId(), FlowNodeStatus.ERROR));
            List<FlowContext<FlowData>> all = this.getContextsByTraceWrapper(REPO, traceId);
    ...
    class FlowManualExecutorInPersistTest extends FlowsDataBaseTest {
        ...
        void testFlowsManualExecutorWithConditionNodeFirstBranchTrue() {
            ...
            From<FlowData> resumeFrom = (From<FlowData>) WaterFlows.getPublisher(resumeContext.getStreamId());
        ...
        void testFlowsManualExecutorWithConditionNodeCircle() {
            ...
            metaId = "event5";
            contexts = FlowsTestUtil.waitSingle(contextSupplier(REPO, streamId, traceId, metaId, FlowNodeStatus.PENDING));
            ...
            resumeFrom = (From<FlowData>) WaterFlows.getPublisher(resumeContext.getStreamId());
            ...
            FlowNode flowNode = flowDefinition.getFlowNode(FlowNodeType.END);
            contexts = FlowsTestUtil.waitSingle(contextSupplier(REPO, streamId, traceId, flowNode.getMetaId(), FlowNodeStatus.ARCHIVED));
            all = this.getContextsByTraceWrapper(REPO, traceId);
    ...
    class FlowAutoExecutorInPersistWithJoberIncludeFitableTest extends FlowsDataBaseTest {
        ...
        void testFlowsExecuteGeneralJoberError() throws Throwable {
            ...
            String metaId = "state1";
            List<FlowContext<FlowData>> contexts = FlowsTestUtil.waitSingle(contextSupplier(REPO, streamId, traceId, metaId, FlowNodeStatus.ERROR));
            List<FlowContext<FlowData>> all = this.getContextsByTraceWrapper(REPO, traceId);
        ...
        void testFlowsExecuteGeneralJoberWithRetryableException() throws Throwable {
            ...
            String metaId = "state1";
            List<FlowContext<FlowData>> contexts = FlowsTestUtil.waitSingle(
                    contextSupplier(REPO, streamId, traceId, metaId, FlowNodeStatus.RETRYABLE));
            List<FlowContext<FlowData>> all = this.getContextsByTraceWrapper(REPO, traceId);
        ...
        void testFlowsExecuteGeneralJoberAndModifyFitables() throws Throwable {
            ...
            List<FlowContext<FlowData>> allContexts = FlowsTestUtil.waitSize(() -> this.getContextsByTraceWrapper(REPO, traceId), 3);
    ...
    class FlowAutoExecutorInPersistMToNTest extends FlowsDataBaseTest {
        ...
        void testFlowsExecuteProduceFromMToNForOfferOneData() {
            ...
            FlowNode flowNode = flowDefinition.getFlowNode(FlowNodeType.END);
            List<FlowContext<FlowData>> contexts = FlowsTestUtil.waitSize(
                    contextSupplier(REPO, streamId, traceId, flowNode.getMetaId(), FlowNodeStatus.ARCHIVED), 3);
            List<FlowContext<FlowData>> all = this.getContextsByTraceWrapper(REPO, traceId);
        ...
        void testFlowsExecuteFilterFromMToN() {
            ...
            contexts1 = FlowsTestUtil.waitFortyMillis(contextSupplier(REPO, streamId, traceId1, eventMetaId, FlowNodeStatus.PENDING));
            assertEquals(1, contexts1.size());
            ...
            contexts2 = FlowsTestUtil.waitFortyMillis(contextSupplier(REPO, streamId, traceId2, eventMetaId, FlowNodeStatus.PENDING));
            assertEquals(1, contexts2.size());
            ...
            contexts3 = FlowsTestUtil.waitEmpty(contextSupplier(REPO, streamId, traceId3, eventMetaId, FlowNodeStatus.PENDING));
        ...
        private void checkContext(List<FlowContext<FlowData>> contexts1, boolean isApproved) {
            ...
            From<FlowData> resumeFrom1 = (From<FlowData>) WaterFlows.getPublisher(resumeContext1.getStreamId());
