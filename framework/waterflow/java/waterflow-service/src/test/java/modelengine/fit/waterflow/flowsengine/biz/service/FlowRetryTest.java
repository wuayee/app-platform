...
class FlowRetryTest extends DatabaseBaseTest {
    ...
    class FlowContextServiceTest extends FlowsDataBaseTest {
        ...
        public void testRetryJoberSuccess() {
            ...
            waterFlows.when(() -> WaterFlows.getPublisher("streamId")).thenReturn(from);
            ...
            flowExecutors.when(() -> FlowExecutors.getThreadPool(
                    StringUtils.join(Constant.STREAM_ID_SEPARATOR, context.getStreamId(), context.getPosition()),
        ...
        public void testEmptyContextRetryTaskSuccess() {
            ...
            flowContextsService.popRetryTask();
