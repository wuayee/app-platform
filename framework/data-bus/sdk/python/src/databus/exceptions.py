...
class CoreError(Exception):
    def __init__(self, error_message_template: str, error_type: CoreErrorType):
        super().__init__()
    ...
    @staticmethod
    def check_core_response(error_message_template: str, error_type: CoreErrorType):
        ...
        """
        if error_type != CoreErrorType.None_:
