...
import static com.huawei.jade.fel.pipeline.huggingface.type.Constant.LIST_MEDIA_TYPE;

import com.huawei.jade.fel.pipeline.huggingface.asr.AsrInput;
import com.huawei.jade.fel.pipeline.huggingface.asr.AsrOutput;
import com.huawei.jade.fel.pipeline.huggingface.img2img.Image2ImageInput;
import com.huawei.jade.fel.pipeline.huggingface.text2img.Text2ImageInput;
import com.huawei.jade.fel.pipeline.huggingface.tts.TtsInput;
import com.huawei.jade.fel.pipeline.huggingface.tts.TtsOutput;
...
public enum PipelineTask {
     ...
     * 音频文本提取。
     *
     * @see com.huawei.jade.fel.pipeline.huggingface.asr.AsrPipeline
     */
     ...
     * 语音合成。
     *
     * @see com.huawei.jade.fel.pipeline.huggingface.text2img.Text2ImagePipeline
     */
     ...
     * 图生图。
     *
     * @see com.huawei.jade.fel.pipeline.huggingface.img2img.Image2ImagePipeline
     */
