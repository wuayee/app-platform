...
graphTest.test("test add and insert pages in a graph", async () => {
    ...
    //init graph
    const p1Name = "page1", p1Id = "page-1";
    ...
    graphTest.assert(0, page1.shapes.length, "new page should have 1 shapes");

    //insert second page before first page
    const p2Name = "page2", p2Id = "page-2";
...
pageTest.test("test add/modify/remove rectangle collaboration command", async () => {
    ...
    const rect2 = page2.shapes.find(s => s.id === rect1.id);
    ...
    pageTest.assert(0, page2.shapes.length, "the second page should follow first page to delete the rectangle");
    ...
    page1.sendChangedPageData();
    pageTest.assert(1, page2.shapes.length, "the second page should follow first page to undo the delete of the rectangle");
    ...
    page1.sendChangedPageData();
    pageTest.assert(0, page2.shapes.length, "the second page should follow first page to redo the delete of the rectangle");
    ...
    page1.graph.getHistory().undo();
    page1.sendChangedPageData();
    pageTest.assert(0, page2.shapes.length, "the second page should follow first page to undo create rectangle");
    pageTest.assert(0, graphs.receiver.graph.pages[0].shapes.length);
    pageTest.assert(0, graphs.sender.graph.pages[0].shapes.length);
});
...
pageTest.test("test change shape index to send collaboration command", async () => {
    ...
    page2.moveIndexBefore(page2.shapes[1], 100);
