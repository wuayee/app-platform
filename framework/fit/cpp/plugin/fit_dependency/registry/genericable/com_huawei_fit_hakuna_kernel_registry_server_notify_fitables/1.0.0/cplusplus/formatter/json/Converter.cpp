...
FIT_REGISTRATIONS
{
    FormatterMetaRegisterHelper<fit::hakuna::kernel::registry::server::__notifyFitables,
        fit::hakuna::kernel::registry::server::notifyFitables, PROTOCOL_TYPE_JSON>(Annotation::FitableType::MAIN);
}
}