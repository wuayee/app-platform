...
FIT_REGISTRATIONS
{
    FormatterMetaRegisterHelper<fit::hakuna::kernel::registry::server::__subscribeFitables,
        fit::hakuna::kernel::registry::server::subscribeFitables, PROTOCOL_TYPE_JSON>(Annotation::FitableType::MAIN);
}
}