...
FIT_REGISTRATIONS
{
    FormatterMetaRegisterHelper<fit::hakuna::kernel::registry::server::__registerFitables,
        fit::hakuna::kernel::registry::server::registerFitables, PROTOCOL_TYPE_JSON>(Annotation::FitableType::MAIN);
}
}