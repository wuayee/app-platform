...
FIT_REGISTRATIONS
{
    FormatterMetaRegisterHelper<fit::hakuna::kernel::registry::server::__queryFitablesAddresses,
        fit::hakuna::kernel::registry::server::queryFitablesAddresses, PROTOCOL_TYPE_JSON>(
