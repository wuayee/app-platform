...
FIT_REGISTRATIONS
{
    FormatterMetaRegisterHelper<fit::hakuna::kernel::registry::server::__unsubscribeFitables,
        fit::hakuna::kernel::registry::server::unsubscribeFitables, PROTOCOL_TYPE_JSON>(Annotation::FitableType::MAIN);
}
}