 ...
 * Date         :
 */
#ifndef COM_HUAWEI_FIT_HAKUNA_KERNEL_REGISTRY_SHARED_ADDRESS_JSON_CONVERTER_H
#define COM_HUAWEI_FIT_HAKUNA_KERNEL_REGISTRY_SHARED_ADDRESS_JSON_CONVERTER_H

#include <fit/external/framework/formatter/json_converter.hpp>
#include <component/com_huawei_fit_hakuna_kernel_registry_shared_Endpoint/1.0.0/cplusplus/formatter/json/Converter.hpp>
#include "../../Address.hpp"
