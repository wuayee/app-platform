...
class FitableRegistryFitableRepositoryMemoryTest : public ::testing::Test {
public:
...
TEST_F(FitableRegistryFitableRepositoryMemoryTest, should_return_true_when_save_fit_service_given_fit_service)
{
    // given
...
TEST_F(FitableRegistryFitableRepositoryMemoryTest,
...
TEST_F(FitableRegistryFitableRepositoryMemoryTest,
    should_return_empty_when_save_service_and_query_given_invalid_key)
{
    // given
    bool expectedRet = true;
    ...
    // then
    EXPECT_EQ(ret, expectedRet);
    EXPECT_EQ(actualServiceSet.empty(), true);
}
    ...
    should_return_true_when_save_service_and_query_given_fit_service_set_and_key)
{
    ...
    ASSERT_EQ(actualServiceSet.begin()->service.addresses.size(), actualServiceSet.begin()->service.addresses.size());
    ...
    should_return_true_when_delete_and_query_given_fitable_and_address)
{
    ...
    db_service_set actualServiceSet = memoryRepo->Query(key);
    int32_t actualRemoveRet = memoryRepo->Remove(fitableRemove, addressRemove_);
...
TEST_F(FitableRegistryFitableRepositoryMemoryTest,
    should_return_empty_when_sync_save_fit_service_and_get_all_given_fit_service)
{
    // given
    ...
    auto queryResult = memoryRepo->GetAllServices();
...
TEST_F(FitableRegistryFitableRepositoryMemoryTest, should_return_true_when_sync_save_fit_service_given_fit_service)
{
    // given
    int32_t expectedRet = REGISTRY_SUCCESS;
    FitRegistryMemoryRepositoryPtr memoryRepo =
    ...
    should_return_true_when_sync_delete_and_query_given_fitable_and_address)
{
    ...
    db_service_set actualServiceSet = memoryRepo->Query(key);
    int32_t actualRemoveRet = memoryRepo->SyncRemove(serviceInfoRemove);
    db_service_set actualServiceSetAfterRemove = memoryRepo->Query(key);
...
TEST_F(FitableRegistryFitableRepositoryMemoryTest,
    should_return_true_when_sync_delete_services_and_query_given_fitable_and_address)
{
    // given
    int32_t expectedRet = REGISTRY_SUCCESS;
    ...
    serviceInfoRemove.service.addresses.emplace_back(addressRemove_);
    serviceInfoRemove.service.fitable = fitableRemove;
    serviceInfoSet.emplace_back(serviceInfoRemove);
    db_service_set expectedSetAfterRemove;
    int32_t expectedRetRemove = REGISTRY_SUCCESS;
    ...
    db_service_set actualServiceSet = memoryRepo->Query(key);
    int32_t actualRemoveRet = memoryRepo->SyncRemove(serviceInfoSet);
    db_service_set actualServiceSetAfterRemove = memoryRepo->Query(key);
