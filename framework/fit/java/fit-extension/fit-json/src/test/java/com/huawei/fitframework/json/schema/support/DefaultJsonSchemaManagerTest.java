...
public class DefaultJsonSchemaManagerTest {
    ...
    void setup() {
        ...
        this.manager = new DefaultJsonSchemaManager(serializer);
    }
    ...
    class TestMethod {
        ...
        void shouldReturnCorrectSchemaGivenCustomObject() throws NoSuchMethodException {
            ...
            Map<String, Object> p1 = cast(properties.get("p1"));
            assertThat(p1).containsEntry("type", "object");
            Map<String, Object> p1Properties = cast(p1.get("properties"));
            ...
            Map<String, Object> p2 = cast(properties.get("p1"));
            assertThat(p2).containsEntry("type", "object");
            Map<String, Object> p2Properties = cast(p2.get("properties"));
