...
public class DecoratedSchema extends AbstractJsonSchema {
    ...
    DecoratedSchema(String name, String description, JsonSchema schema, ObjectSerializer serializer) {
        super(schema, serializer);
    ...
    public Map<String, Object> toMap() {
        Map<String, Object> map = this.schema.toMap();
        if (StringUtils.isNotBlank(this.description())) {
