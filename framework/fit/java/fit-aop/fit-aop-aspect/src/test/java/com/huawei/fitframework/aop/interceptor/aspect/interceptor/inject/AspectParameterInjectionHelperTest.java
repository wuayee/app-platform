...
import com.huawei.fitframework.aop.interceptor.aspect.type.support.DefaultJoinPoint;
import com.huawei.fitframework.aop.interceptor.aspect.type.support.DefaultSignature;
import com.huawei.fitframework.aop.interceptor.support.DefaultMethodMatcherCollection;
...
class AspectParameterInjectionHelperTest {
    ...
    private Object[] getInjectionArgs(String internalParameters, Object[] args, Object result, Class<?> classType)
        ...
        ParameterInjection parameterInjection = mock(ParameterInjection.class);
