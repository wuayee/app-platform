...
public interface Request {
     ...
     * 获取请求元数据信息。
     *
     * @return 表示请求元数据的 {@link RequestMetadataV2}。
     */
    RequestMetadataV2 metadata();
    ...
    interface Builder {
         ...
         * 向当前构建器中设置请求的元数据。
         *
         * @param metadata 表示待设置的请求元数据的 {@link RequestMetadataV2}。
         * @return 表示当前构建器的 {@link Builder}。
         */
        Builder metadata(RequestMetadataV2 metadata);
