...
public class DefaultRequest implements Request {
    ...
    private final RequestMetadataV2 metadata;
    private final Type[] dataTypes;
    private final Object[] data;
    private final Type returnType;
    private final RequestContext context;

    private DefaultRequest(String protocol, Address address, RequestMetadataV2 metadata, Type[] dataTypes,
            Object[] data, Type returnType, RequestContext context) {
    ...
    @Override
    public RequestMetadataV2 metadata() {
    ...
    public static class Builder implements Request.Builder {
        ...
        @Override
        public Request.Builder metadata(RequestMetadataV2 metadata) {
