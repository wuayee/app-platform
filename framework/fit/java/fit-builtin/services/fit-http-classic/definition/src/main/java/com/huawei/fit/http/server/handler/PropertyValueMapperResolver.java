...
import com.huawei.fit.http.server.handler.support.PropertyClassicRequestResolver;
import com.huawei.fit.http.server.handler.support.PropertyClassicResponseResolver;
...
public interface PropertyValueMapperResolver {
    ...
    static PropertyValueMapperResolver defaultResolver() {
        return PropertyValueMapperResolver.combine(new PropertyClassicRequestResolver(),
                new PropertyClassicResponseResolver(),
                new EntityResolver());
    }
