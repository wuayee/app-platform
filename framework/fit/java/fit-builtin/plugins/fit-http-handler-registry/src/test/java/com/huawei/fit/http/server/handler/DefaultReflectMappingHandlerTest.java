...
/**
 * 表示 {@link DefaultReflectMappingHandler} 的单元测试。
 *
 * @author 杭潇 h00675922
 * @since 2023-02-24
 */
@DisplayName("测试 DefaultReflectMappingHandler 类")
public class DefaultReflectMappingHandlerTest {
    private DefaultReflectMappingHandler defaultReflectMappingHandler;
    ...
    void setup() {
        ...
        this.defaultReflectMappingHandler = new DefaultReflectMappingHandler(staticInfo, executionInfo);
    }
    ...
    private HttpHandler.ExecutionInfo initializeExecutionInfo() {
        ...
        Optional<Method> initializeExecutionInfo =
                ReflectionUtils.findMethod(DefaultReflectMappingHandlerTest.class, "initializeExecutionInfo");
    ...
    class AddCustomJsonSerializer {
        ...
        private void addCustomJsonSerializer(ObjectSerializer serializer) {
            DefaultReflectMappingHandlerTest.this.defaultReflectMappingHandler.addCustomJsonSerializer(serializer);
        }
    }
    ...
    class HandleException {
        ...
        void setup() {
            ...
            DefaultHttpExceptionHandler defaultHttpExceptionHandler = new DefaultHttpExceptionHandler("target",
                    DefaultReflectMappingHandlerTest.this.method,
                    200,
                    DefaultReflectMappingHandlerTest.this.propertyValueMappers,
                    Scope.PLUGIN);

            exceptionHandlers.put(throwableClass, defaultHttpExceptionHandler);
            DefaultReflectMappingHandlerTest.this.defaultReflectMappingHandler.addPluginExceptionHandler(
                    exceptionHandlers);
        }
        ...
        void givenUnHandledExceptionThenLogIsRecorded() {
            ...
            DefaultReflectMappingHandlerTest.this.defaultReflectMappingHandler.handleException(
                    DefaultReflectMappingHandlerTest.this.request,
                    DefaultReflectMappingHandlerTest.this.response,
                    DefaultReflectMappingHandlerTest.this.args,
                    throwable);
            Optional<Entity> entity = DefaultReflectMappingHandlerTest.this.response.entity();
    ...
    class TestSetEntity {
        ...
        void givenResultParameterIsNullThenReturnEntityIsNull() {
            DefaultReflectMappingHandlerTest.this.defaultReflectMappingHandler.handleResult(
                    DefaultReflectMappingHandlerTest.this.request,
                    DefaultReflectMappingHandlerTest.this.response,
                    DefaultReflectMappingHandlerTest.this.args,
                    null);
