...
import com.huawei.fit.http.server.handler.DefaultReflectMappingHandler;
...
public class DefaultHttpHandlerResolver implements HttpHandlerResolver {
    ...
    private class Resolver {
        ...
        private DefaultReflectMappingHandler resolve(HttpHandler.StaticInfo staticInfo,
                HttpHandler.ExecutionInfo executionInfo) {
            return new DefaultReflectMappingHandler(staticInfo, executionInfo);
        }
