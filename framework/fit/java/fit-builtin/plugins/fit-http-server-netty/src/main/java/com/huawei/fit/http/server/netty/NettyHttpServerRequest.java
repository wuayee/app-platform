...
import com.huawei.fit.http.protocol.util.HeaderUtils;
...
public class NettyHttpServerRequest implements ServerRequest, OnHttpContentReceived {
    ...
    NettyHttpServerRequest(HttpRequest request, ChannelHandlerContext ctx, boolean isSecure, long largeBodySize) {
