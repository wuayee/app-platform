...
import com.huawei.fitframework.conf.ConfigChainListener;
...
public class DefaultConfigChain extends AbstractConfig implements ConfigChain {
    ...
    private static Object merge(Object value1, Object value2) {
        if (value1 == null) {
            ...
            Map<Object, Object> map1 = cast(as(value1, Map.class));
            Map<Object, Object> map2 = cast(as(value2, Map.class));
    ...
    private static Object mergeValues(Object value1, Object value2) {
        List<Object> list1 = Optional.ofNullable(ObjectUtils.<List<Object>>cast(as(value1, List.class)))
                .orElseGet(() -> Collections.singletonList(value1));
        List<Object> list2 = Optional.ofNullable(ObjectUtils.<List<Object>>cast(as(value2, List.class)))
