...
import com.huawei.fitframework.conf.runtime.MatataConfig.Registry.AvailableService;
...
/**
 * 表示 {@link AvailableService} 的默认实现。
 *
 * @author 季聿阶 j00559309
 * @since 2023-06-27
 */
public class DefaultAvailableService implements AvailableService {
    ...
    public void setFormats(List<Integer> formats) {
        this.formats = nullIf(formats, Collections.emptyList());
    }
