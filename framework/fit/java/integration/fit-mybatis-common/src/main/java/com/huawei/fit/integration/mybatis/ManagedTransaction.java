...
class ManagedTransaction implements Transaction {
    ...
    private final com.huawei.fitframework.transaction.Transaction transaction;
    private int state = STATE_NONE;

    ManagedTransaction(com.huawei.fitframework.transaction.Transaction transaction) {
