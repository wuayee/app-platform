 ...
 * @since 2023-01-04
 */
@AssignmentTarget(byteValue = 3, charValue = 'c', doubleValue = 12.1, floatValue = 4, integerValue = 23, longValue = 5,
        shortValue = 6, booleanValue = true, stringValue = "stringValue", fruitColor = AssignmentTarget.EnumValue.BLUE,
        arrayValue = {"a", "b"}, classValue = String.class, annotationValue = @NestAssignmentTarget(integerValue = 1))
