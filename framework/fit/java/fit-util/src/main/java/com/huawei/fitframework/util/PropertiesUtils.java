...
import com.huawei.fitframework.util.support.PropertyKey;
import com.huawei.fitframework.util.support.PropertyKeys;
...
public class PropertiesUtils {
    ...
    public static Map<String, Object> mapFrom(Properties properties) {
        ...
        properties.forEach((key, value) -> source.put(cast(key), cast(value)));
    ...
    private static void mapFromArrayValue(PropertyKeys keys, int index, String value,
        ...
        List<SortedMap<String, Object>> currentValues =
                cast(result.computeIfAbsent(propertyKey.getActualKey(), key -> new ArrayList<Map<String, Object>>()));
    ...
    private static void mapFromLastArrayValue(PropertyKey propertyKey, String value, SortedMap<String, Object> result) {
        List<String> currentValues =
                cast(result.computeIfAbsent(propertyKey.getActualKey(), key -> new ArrayList<String>()));
    ...
    private static void mapFromObjectValue(PropertyKeys keys, int index, String value,
        ...
        SortedMap<String, Object> currentValue =
                cast(result.computeIfAbsent(keys.get(index).getActualKey(), key -> new TreeMap<String, Object>()));
