...
import com.huawei.fitframework.ioc.annotation.circular.Circular;
import com.huawei.fitframework.ioc.annotation.circular.CircularAnnotationConsumer;
import com.huawei.fitframework.ioc.annotation.convert.IntValue;
import com.huawei.fitframework.ioc.annotation.convert.ValueConvertedAnnotationConsumer;
import com.huawei.fitframework.ioc.annotation.repeatable.RepeatableAnnotationConsumer;
import com.huawei.fitframework.ioc.annotation.repeatable.Value;
import com.huawei.fitframework.ioc.annotation.support.DefaultAnnotationMetadataResolver;
import com.huawei.fitframework.ioc.annotation.traditional.ThirdLevel;
import com.huawei.fitframework.ioc.annotation.traditional.TraditionalAnnotationConsumer;
