...
import com.huawei.fitframework.ioc.lifecycle.bean.support.BeanInjectorComposite;
import com.huawei.fitframework.ioc.lifecycle.bean.support.FieldBeanInjector;
import com.huawei.fitframework.ioc.lifecycle.bean.support.MethodBeanInjector;
...
public class BeanInjectors {
     ...
     * @throws com.huawei.fitframework.ioc.BeanDefinitionException {@code field} 被 {@code final} 或 {@code static} 修饰。
     */
