...
import com.huawei.fitframework.broker.client.ioc.DynamicRoutingDependencyResolver;
import com.huawei.fitframework.conf.Config;
import com.huawei.fitframework.conf.ConfigChain;
import com.huawei.fitframework.conf.ConfigLoadException;
import com.huawei.fitframework.conf.ConfigLoader;
import com.huawei.fitframework.conf.Configs;
import com.huawei.fitframework.conf.support.DefaultConfigChain;
...
public abstract class AbstractFitRuntime extends AbstractDisposable implements FitRuntime {
    private static final String FRAMEWORK_VERSION = "3.3.11-SNAPSHOT";
    ...
    public AbstractFitRuntime(Class<?> entry, String[] args) {
        this.entry = entry;
        this.args = nullIf(args, StringUtils.EMPTY_ARRAY);
        this.started = false;
    ...
    private static String getActiveProfileName(Config globalConfig) {
        ...
        activeProfile = nullIf(StringUtils.trim(activeProfile), StringUtils.EMPTY);
    ...
    private static Config loadStartupConfig(String[] args) {
        ...
        for (String argument : args) {
            ...
            if (current == null) {
                ...
                List<String> values = cast(current);
                values.add(value);
            } else {
