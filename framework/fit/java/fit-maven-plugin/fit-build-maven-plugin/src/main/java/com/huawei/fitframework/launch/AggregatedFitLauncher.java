...
import static com.huawei.fitframework.protocol.jar.JarEntryLocation.ENTRY_PATH_SEPARATOR;

import com.huawei.fitframework.protocol.Handlers;
...
public final class AggregatedFitLauncher {
    /** 表示 META-INF 的目录的入口名。 */
    public static final String META_DIRECTORY_ENTRY_NAME = "META-INF" + ENTRY_PATH_SEPARATOR;

    /** 表示 MANIFEST.MF 的入口名。 */
    public static final String MANIFEST_ENTRY_NAME = META_DIRECTORY_ENTRY_NAME + "MANIFEST.MF";

    /** 表示 FIT-INF 的目录的入口名。 */
    public static final String FIT_ROOT_ENTRY_NAME = "FIT-INF" + ENTRY_PATH_SEPARATOR;

    /** 表示类文件的目录的入口名。 */
    public static final String CLASS_DIRECTORY_ENTRY_NAME = FIT_ROOT_ENTRY_NAME + "classes" + ENTRY_PATH_SEPARATOR;

    /** 表示标准库的目录的入口名。 */
    public static final String LIB_ENTRY_NAME = FIT_ROOT_ENTRY_NAME + "lib" + ENTRY_PATH_SEPARATOR;

    /** 表示三方库的目录的入口名。 */
    public static final String THIRD_PARTY_ENTRY_NAME = FIT_ROOT_ENTRY_NAME + "third-party" + ENTRY_PATH_SEPARATOR;

    /** 表示共享库的目录的入口名。 */
    public static final String SHARED_ENTRY_NAME = FIT_ROOT_ENTRY_NAME + "shared" + ENTRY_PATH_SEPARATOR;
