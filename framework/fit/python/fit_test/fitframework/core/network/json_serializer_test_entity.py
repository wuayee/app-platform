...
class _TestA:
    ...
    def __eq__(self, other):
        return isinstance(other, _TestA) and self.a_arg_1 == other.a_arg_1 and self.a_arg_2 == other.a_arg_2 and self.a_arg_3 == other.a_arg_3
...
class _TestC:
    ...
    def __eq__(self, other):
        return isinstance(other, _TestC) and self.c_arg_1 == other.c_arg_1 and self.c_arg_2 == other.c_arg_2 and self.c_arg_3 == other.c_arg_3
...
class _TestD(Generic[T]):
    ...
    def __eq__(self, other):
        return isinstance(other, _TestD) and self.code == other.code and self.message == other.message and self.data == other.data
