...
class ConfigureBasedBrokerTest(FitTestSupport):
    ...
    def test_routing_default(self, mock_get_fit_ffp_fitable_id, mock_invoke, _, *__):
        ...
        mock_get_fit_ffp_fitable_id.side_effect = lambda _, key: ffp_dict[key]
...
# TODO: recover this when fitable id changes to UUID
#    @patch.object(configure_based_brokerimpl, 'get_fit_ffp_fitable_id')
#    def test_get_degradation(self, mock_get_fitable_id):
#        ConfigureBasedBroker().get_degradation('gen1', 'fitable1')
#        mock_get_fitable_id.assert_called_once_with('gen1', f"fitables.fitable1.degradation")
