...
class MyTestCase(unittest.TestCase):
    def test_grpc_protobuf_priority(self):
        addresses = [
            Address(host='localhost', port=8889, protocol=3, formats=[0, 1], id='localhost:8889', environment='test'),
            Address(host='localhost', port=8888, protocol=2, formats=[0, 1], id='localhost:8888', environment='test')
        ]
