...
# 某个插件所拥有的 fit 列表 - key: plugin_name, value: List[generic_id]
_plugin_fit_repo = defaultdict(list)
...
def _set_at_fit_ref(generic_id, func_ref) -> None:
    ...
    _plugin_fit_repo[get_plugin_name_with_func_ref(func_ref)].append(generic_id)
