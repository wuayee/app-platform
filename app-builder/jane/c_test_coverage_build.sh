...
-DscmVersionType=revision -DscmVersion=${commitId} -DconnectionUrl=scm:git:${TARGET_REPO} -Dmaven.test.failure.ignore=true -Djacoco-agent.destfile=target/jacoco.exec
