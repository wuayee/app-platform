...
public enum ErrorCodes {
    ...
    FLOW_EXECUTE_ASYNC_JOBER_FAILED(10007027,
            "execute async jober failed, errors: {0}"),
     ...
     * 流程出现系统错误
     */
    FLOW_SYSTEM_ERROR(10007503, "Error code: 10007503, SYSTEM ERROR"),
    ...
    /**
     * ------------ w3 Exception. From 10012000 to 10012999 ---------------------
     */
    W3_INFO_INVALID(10012001, "Failed to invoke the W3 interface, message: {0}"),
    W3_FIELD_REQUIRED(10012002, "The {0} of W3 is required, but not provided."),
    ...
    /**
     * ------------ TianZhou Plugin Exception. From 10014000 to 10014999 ---------------------
     */
     ...
     */
    FLOW_GRAPH_AMOUNT_EXCEED_LIMITATION(10015001, "Flow template amount exceeds limitation {0}"),
