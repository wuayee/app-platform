...
public abstract class TaskInstanceEntity<T extends TaskInstanceEntity<T>> {
    ...
    public Map<String, Object> getInfos() {
        return this.info.entrySet().stream().collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));
    }
    ...
    public long getResumeDuration() {
        return Long.parseLong(ObjectUtils.cast(this.info.getOrDefault(AippConst.INST_RESUME_DURATION_KEY, "0")));
    }
