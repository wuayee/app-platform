...
public class AppTemplateServiceImplTest {
    ...
    void testPublishAppTemplateFromApp() throws IOException {
        ...
        verify(this.uploadedFileManageService, times(1)).addFileRecord(any(), eq("w3_account"), any(), any());
    ...
    private OperationContext mockOperationContext() {
        return new OperationContext("tenant_id", "operator", "global_user_id", "w3_account", "employ_number", "name",
