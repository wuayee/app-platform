...
import static com.huawei.fit.jober.flowsengine.utils.FlowUtil.mergeMaps;
...
import com.huawei.fit.jober.flowsengine.domain.flows.definitions.callbacks.FlowEventCallback;
...
public class FlowContextsService {
    ...
    public void resumeFlows(String flowId, Map<String, Map<String, Object>> contexts) {
        ...
        exits.forEach(c -> {
            ...
            c.getData()
                    .setBusinessData(mergeMaps(c.getData().getBusinessData(),
    ...
    public List<Map<String, Object>> findContextStatusViewByStreamIds(List<String> streamIds,
        ...
        flowContextMap.values().forEach(list -> {
            ...
            Map<String, Object> view = Views.flowContextCountViewOf(flowContexts);
            if (!view.isEmpty()) {
                result.add(view);
            }
        });
