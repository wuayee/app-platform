...
import com.huawei.fit.jober.flowsengine.domain.flows.streams.Processors.ArrayInvoke;
...
import com.huawei.fit.jober.flowsengine.domain.flows.streams.Processors.Invoke;
...
public final class FitStream {
    ...
    public interface Source<T> extends Identity {
         ...
         * @return Publisher<T>
         */
        Publisher<T> mono(Invoke<T> invoker);
         ...
         * @return Publisher<T>
         */
        Publisher<T> flux(ArrayInvoke<T> invoker);
    ...
    public interface Publisher<I> extends StreamIdentity, InterStreamHandler<I> {
         ...
         */
        <O> Processor<O, O> conditions(Just<FlowContext<O>> processor, Map<I, O> convert, Whether<I> whether);
         ...
         * @return Processor<O, O>
         */
        <O> Processor<O, O> parallel(Just<FlowContext<O>> processor, ParallelMode mode, Map<I, O> convert,
                Whether<I> whether);
         ...
         * @return Processor<O, O>
         */
        <O> Processor<O, O> just(Just<FlowContext<O>> processor, Map<I, O> convert, Whether<I> whether);
         ...
         * @return Processor<M, O>
         */
        <M, O> Processor<M, O> map(Map<FlowContext<M>, O> processor, Map<I, M> convert, Whether<I> whether);
         ...
         * @param whether whether
         */
        <M, O> void subscribe(Subscriber<M, O> subscriber, Map<I, M> convert, Whether<I> whether);
         ...
         * @param whether whether
         */
        <M, O> void subscribe(String eventId, Subscriber<M, O> subscriber, Map<I, M> convert, Whether<I> whether);
    ...
    public interface Subscriber<I, O> extends StreamIdentity, InterStream<O> {
         ...
         */
        void onComplete(Just<Callback<FlowContext<O>>> callback);
         ...
         * @param handler handler
         */
        void onGlobalError(Error handler);
    }
