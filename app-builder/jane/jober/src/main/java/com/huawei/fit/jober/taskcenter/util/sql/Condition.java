...
import com.huawei.fit.jober.taskcenter.util.sql.condition.AlwaysFalseCondition;
import com.huawei.fit.jober.taskcenter.util.sql.condition.AlwaysTrueCondition;
import com.huawei.fit.jober.taskcenter.util.sql.condition.BetweenCondition;
import com.huawei.fit.jober.taskcenter.util.sql.condition.ContainsCondition;
import com.huawei.fit.jober.taskcenter.util.sql.condition.DefaultCondition;
import com.huawei.fit.jober.taskcenter.util.sql.condition.EqualsCondition;
import com.huawei.fit.jober.taskcenter.util.sql.condition.GreaterThanCondition;
import com.huawei.fit.jober.taskcenter.util.sql.condition.GreaterThanOrEqualsCondition;
import com.huawei.fit.jober.taskcenter.util.sql.condition.InCondition;
import com.huawei.fit.jober.taskcenter.util.sql.condition.LessThanCondition;
import com.huawei.fit.jober.taskcenter.util.sql.condition.NotEqualsCondition;
