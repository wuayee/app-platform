...
public interface Rules {
     ...
     */
    default Supplier<JobberParamException> exception(String paramName) {
        return () -> new JobberParamException(INPUT_PARAM_IS_INVALID, paramName);
    }
    ...
    default <T> void validateEmpty(List<T> list, String paramName) {
        if (CollectionUtils.isNotEmpty(list)) {
            throw new JobberParamException(INPUT_PARAM_IS_INVALID, paramName);
        }
    }
