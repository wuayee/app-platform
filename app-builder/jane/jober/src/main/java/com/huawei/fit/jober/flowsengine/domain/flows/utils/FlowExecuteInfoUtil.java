...
package com.huawei.fit.jober.flowsengine.domain.flows.utils;

import static com.huawei.fit.jober.common.Constant.BUSINESS_DATA_INTERNAL_KEY;
import static com.huawei.fit.jober.common.Constant.INTERNAL_EXECUTE_INFO_KEY;
...
public class FlowExecuteInfoUtil {
    ...
    private static void addKeyValueToExecuteInfo(FlowData flowData, String nodeMetaId, String executeInfoType,
        ...
        Map<String, Object> internalMap = cast(businessData.getOrDefault(BUSINESS_DATA_INTERNAL_KEY, new HashMap<>()));
        Map<String, Object> executeInfoMap = cast(internalMap.getOrDefault(INTERNAL_EXECUTE_INFO_KEY, new HashMap<>()));
        ...
        internalMap.put(INTERNAL_EXECUTE_INFO_KEY, executeInfoMap);
        businessData.put(BUSINESS_DATA_INTERNAL_KEY, internalMap);
    }
}
