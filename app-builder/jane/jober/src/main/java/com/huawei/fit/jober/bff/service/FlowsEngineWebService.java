...
public class FlowsEngineWebService implements FlowsEngineService {
    ...
    public FlowsEngineWebService(FlowsController flowsController, FlowsService flowsService,
            FlowContextsController flowContextsController, FlowsGraphRepo flowsGraphRepo, Authenticator authenticator,
            TagService tagService, QueryFlowContextPersistRepo queryFlowContextPersistRepo) {
        this.flowsController = flowsController;
        this.flowsService = flowsService;
        this.flowContextsController = flowContextsController;
    ...
    public GetPageResponse findFlowDefinitionsPage(String queryData, HttpClassicServerRequest httpRequest,
        ...
        List<Map<String, Object>> flows = flowsController.findFlowsByStreamIds(httpRequest, null, tenantId,
                new ArrayList<>(flowInfoMap.keySet()));
        flows.forEach(f -> {
        ...
        List<Map<String, Object>> flowContexts = flowContextsController.findContextStatusViewByStreamIds(httpRequest,
                null, tenantId, new ArrayList<>(flowInfoMap.keySet()));
    ...
    public Map<String, Object> createFlows(Map<String, Object> data, HttpClassicServerRequest httpRequest,
        ...
        Map<String, Object> flowsView = flowsController.createFlows(httpRequest, null, tenantId, flowGraph);
