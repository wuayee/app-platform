...
public class TagFitable implements TagService {
    private modelengine.fit.jober.taskcenter.service.TagService tagService;

    public TagFitable(modelengine.fit.jober.taskcenter.service.TagService tagService) {
