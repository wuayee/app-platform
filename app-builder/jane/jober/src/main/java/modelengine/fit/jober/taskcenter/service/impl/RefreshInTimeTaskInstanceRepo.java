...
import modelengine.fit.jane.task.SourcedTaskInstanceService;
...
public class RefreshInTimeTaskInstanceRepo {
    ...
    private static modelengine.fit.jober.entity.OperationContext convert(OperationContext context) {
        return new modelengine.fit.jober.entity.OperationContext(context.tenantId(), context.operator(),
