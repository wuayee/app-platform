...
import modelengine.fit.jane.meta.MetaService;
...
public class MetaFitable implements MetaService {
    ...
    public MetaFitable(TaskService taskService,
    ...
    public Meta create(MetaDeclarationInfo declaration, OperationContext context) {
        ...
        modelengine.fit.jane.task.util.OperationContext operationContext = ParamUtils.convertToInternalOperationContext(
                context);
    ...
    private List<Meta> convert(List<TaskEntity> entityList, modelengine.fit.jane.task.util.OperationContext context) {
