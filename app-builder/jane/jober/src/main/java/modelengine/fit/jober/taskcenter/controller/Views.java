...
import modelengine.fit.jane.task.domain.PropertyCategoryDeclaration;
import modelengine.fit.jane.task.domain.TaskRelation;
...
import modelengine.fit.jober.taskcenter.declaration.InstanceDeclaration;
...
import modelengine.fit.jober.taskcenter.declaration.TenantDeclaration;
...
import modelengine.fit.jober.taskcenter.domain.OperationRecordEntity;
...
import modelengine.fit.jober.taskcenter.domain.TaskInstanceCount;
...
import modelengine.fit.jober.taskcenter.domain.TreeEntity;
import modelengine.fit.jober.taskcenter.domain.TriggerEntity;
import modelengine.fit.jober.taskcenter.domain.portal.TaskNode;
import modelengine.fit.jober.taskcenter.filter.OperationRecordFilter;
import modelengine.fit.jober.taskcenter.filter.TaskFilter;
import modelengine.fit.jober.taskcenter.filter.TaskTemplateFilter;
...
public final class Views {
     ...
     *
     * @param view 表示包含声明信息的视图的 {@link Map}{@code <}{@link String}{@code , }{@link Object}{@code >}。
     * @return 表示从视图中解析到的任务属性的 {@link modelengine.fit.jane.task.domain.TaskProperty.Declaration}。
     */
    public static modelengine.fit.jane.task.domain.TaskProperty.Declaration declareProperty(Map<String, Object> view) {
        if (view == null) {
            return null;
        }
     ...
     */
    public static Map<String, Object> viewOf(modelengine.fit.jane.task.domain.TaskProperty property) {
