...
public class MetaConverterImpl implements MetaConverter {
    ...
    @Override
    public modelengine.fit.jane.meta.multiversion.definition.Meta convert2MultiVersionMeta(TaskEntity task,
            OperationContext context) {
        modelengine.fit.jane.meta.multiversion.definition.Meta meta
                = new modelengine.fit.jane.meta.multiversion.definition.Meta();
