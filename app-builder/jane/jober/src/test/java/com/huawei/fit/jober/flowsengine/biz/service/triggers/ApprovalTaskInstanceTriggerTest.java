...
import modelengine.fit.waterflow.flowsengine.biz.service.FlowRuntimeServiceImpl;
...
public class ApprovalTaskInstanceTriggerTest extends DatabaseBaseTest {
    ...
    private static final modelengine.fit.jober.flowsengine.biz.service.triggers.ApprovalTaskInstanceTrigger TRIGGER;
    ...
    static {
        ...
        FLOW_CONTEXT_REPO = new FlowContextPersistRepo(FLOW_CONTEXT_MAPPER, TRACE_REPO, FLOW_RETRY_REPO,
                TRACE_OWNER_SERVICE, defaultLimitation, useLimit, 1);
        ...
        FLOW_CONTEXTS_SERVICE = new FlowRuntimeServiceImpl(DEFINITION_REPO, FLOW_CONTEXT_REPO, MESSENGER, null, TRACE_REPO,
                FLOW_RETRY_REPO, LOCKS, TRACE_OWNER_SERVICE, null, false, null,
                definitionQueryService, flowQueryService);
        TRIGGER = new modelengine.fit.jober.flowsengine.biz.service.triggers.ApprovalTaskInstanceTrigger(FLOW_CONTEXT_REPO, FLOW_CONTEXTS_SERVICE, definitionQueryService);
    }
