WITH "w_ins" AS (SELECT "ins"."id", "ins"."task_id", "ins"."task_type_id", "ins"."source_id", "ins"."text_1" AS "info_id", "ins"."text_2" AS "info_status"
...
SELECT * FROM "w_ins" ORDER BY "w_ins"."info_id" ASC, "w_ins"."info_status" DESC OFFSET ? LIMIT ?