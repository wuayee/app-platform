...
public class DefaultValueFilterToolInfoTest {
    private Tool.Info toolInfo;

    @BeforeEach
    void setup() {
        this.toolInfo = new DefaultValueFilterToolInfo(this.buildToolInfo());
    }

    Tool.Info buildToolInfo() {
    ...
    void shouldReturnIncorrectResult() {
        Map<String, Object> schema = this.toolInfo.schema();
