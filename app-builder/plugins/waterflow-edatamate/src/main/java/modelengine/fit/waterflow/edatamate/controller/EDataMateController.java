...
import modelengine.fit.waterflow.edatamate.client.FlowConfiguration;
import modelengine.fit.waterflow.edatamate.client.QueryCriteria;
import modelengine.fit.waterflow.edatamate.client.flowsengine.request.CleanDataListQuery;
import modelengine.fit.waterflow.edatamate.entity.CleanTaskPageResult;
import modelengine.fit.waterflow.edatamate.entity.TaskInstanceUpdateInfo;
import modelengine.fit.waterflow.edatamate.service.OrchestratorFitService;
import modelengine.fit.waterflow.edatamate.service.OrchestratorService;
...
public class EDataMateController implements DataCleanClientV2 {
     ...
     * @param taskId 任务id
     * @param instanceId 任务实例id
     * @param data 追加数据，每项对应{@link modelengine.fit.waterflow.flowsengine.domain.flows.context.FlowData}
     */
