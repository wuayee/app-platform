...
import static com.huawei.jade.oms.alarm.util.Constants.LIST_USAGE_COMMAND;
import static com.huawei.jade.oms.alarm.util.Constants.SPACE_REGEX;
import static com.huawei.jade.oms.alarm.util.Constants.USAGE_COMMAND_OUTPUT_LENGTH;
...
public class MetricsCollector {
    ...
    public Map<String, Integer> getStorageUsage() {
        ...
        try {
            List<String> lines = executeCommand(LIST_USAGE_COMMAND);
            lines.forEach(line -> {
                String[] tokens = line.split(SPACE_REGEX);
                if (tokens.length != USAGE_COMMAND_OUTPUT_LENGTH) {
                    return;
                }
